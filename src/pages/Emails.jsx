  ...
  return (
    <div className="dresses">
      <Search
        ...
        setWelayat={setTypeData}
        filter={[{ text: 'newsletter' }, { text: 'deliveryAbroad' }, { text: 'outStock' }, { text: 'newDressmaker' }]}
      />
                  ...
                  {data?.length > 0 &&
                    data.map((mail, index) => (
                      <TableRow
                        ...
                        onClick={() => navigate(`/super/emails/${mail.id}/${mail.type}`)}
                        key={index}
                        hover
                        role="checkbox"
                        tabIndex={-1}
                      >
                        ...
                        <TableCell align={'left'}>{mail.mail}</TableCell>
                        <TableCell align={'left'}>{/* {mail.mail} */}</TableCell>
                        <TableCell align={'left'}>
