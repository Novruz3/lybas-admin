                ...
                {dataColor?.length > 0 &&
                  dataColor?.map((color, index) => (
                    <button
                      ...
                      key={index}
                      className={'rounded-full mr-3 mb-3 border-blue-600 ' + (colorIndex === index ? 'border-2 p-0.5' : '')}
                    >
              ...
              sizes.map((size, index) => (
                <div key={index} className="col-span-2">
                  <div className="dress-input sizes flex justify-between items-center">
                    ...
                    <button className="bg-red-400 rounded text-white h-10 py-1 px-10 mt-5" onClick={() => sizeDelete(index)}>
                      {t('delete')}
                    </button>
                  </div>
                </div>
