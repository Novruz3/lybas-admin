      ...
      <div className="one-comment_content flex mt-5">
            ...
            <div className="data col-span-4">
              ...
              <div className="data_title text-lybas-gray bg-gray-200 rounded-lg flex justify-between items-center pr-5">
                <input
                  ...
                  name="newPassword"
                  onChange={handleInput}
                  className="py-2.5 px-5 w-full bg-gray-200 rounded-lg outline-none"
                />
              </div>
            </div>
          </div>
        ...
        <div className="w-2/5 flex flex-col justify-between">
            ...
            <div className="inputs p-5">
              <div className="flex items-center">
                <div className="image w-[55px] h-[55px] rounded-full flex justify-center items-center bg-gray-100 object-cover mr-3 overflow-hidden">
                  {image.url ? <img className="h-full" src={image.url} alt="" /> : <Person2Icon sx={{ width: '90%', height: '90%' }} />}
                </div>
                <div className="titleAndAction flex flex-col justify-center">
                  ...
                  <div className="actions flex items-center">
                    ...
                    <button className="text-lybas-gray" onClick={() => (setImage(''), setData({ ...data, image: '' }))}>
                      {t('delete')}
                    </button>
                  </div>
                </div>
          ...
          <div className="actions flex">
            <button onClick={() => navigate('/super')} className="w-full bg-white rounded-lg py-2 mr-5 hover:bg-gray-100">
              {t('cancel')}
            </button>
            <button onClick={sendData} className="bg-lybas-blue text-white rounded-lg w-full py-2 hover:bg-blue-700">
              {t('save')}
            </button>
          </div>
        </div>
