  ...
  return (
    <div className="dresses">
      <Search
        ...
        title="dresses"
        className="mt-5"
        action={{ link: '/dresses/add', text: 'addDress' }}
                  ...
                  {data?.length > 0 &&
                    data.map((market, index) => (
                      <TableRow key={index} hover role="checkbox" tabIndex={-1}>
                        ...
                        <TableCell align={'left'}>{market?.discount ? market?.price_old : market.price}</TableCell>
                        <TableCell align={'left'}>{market.material['name_' + lang]}</TableCell>
                        <TableCell align={'left'}>
                          ...
                          <div className="flex justify-end items-end">
                            <div
                              className={
                                ...
                                (market.recommended ? 'bg-blue-600' : 'bg-gray-300')
                              }
