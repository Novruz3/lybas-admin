...
import { fetchDataDressmakers, setLimit as setLimitDressmaker } from '../redux/features/Dressmakers';
...
function DressesAdd() {
  ...
  const dataDressmakers = useSelector((state) => state?.Dressmakers?.data);
      ...
      try {
        ...
        if (res.status === 200) {
          ...
          for (let i = 0; i < res.data.images.length; i++) {
            images.push({
              url: api + res.data.images[i].image,
  ...
  const deleteImage = async (index, image) => {
    if (image.id) {
      try {
        const res = await AxiosCustom('/products/delete/image/' + image.id, { method: 'POST' });
        console.log(res);
      } catch (error) {
        console.log(error);
      }
      ...
      <div className="dress-add_content flex justify-between mt-5">
        <div className="dress-add_content_left w-3/5 h-[70vh] overflow-auto rounded-lg border bg-white mr-5">
          ...
          <div className="inputs grid grid-cols-2 gap-5 p-5">
            <div className="dress-input">
              <label className="label font-semibold block mb-2.5" htmlFor="name-tm">
                {t('nameTm')}
              </label>
              <input
                name="name_tm"
                ...
                placeholder={t('nameTm')}
                id="name-tm"
              />
            </div>
            <div className="dress-input">
              <label className="label font-semibold block mb-2.5" htmlFor="name-en">
                {t('nameEn')}
              </label>
              <input
                name="name_en"
            ...
            <div className="dress-input">
              <label className="label font-semibold block mb-2.5" htmlFor="name-ru">
                {t('nameRu')}
              </label>
              <input
                name="name_ru"
            ...
            <div className="dress-input">
              ...
              <FormControl fullWidth>
                <Select labelId="multi-select-label" id="multi-select" value={data.materialId} name="materialId" onChange={handleInput}>
            ...
            <div className="dress-input">
              <label className="label font-semibold block mb-2.5" htmlFor="price">
                {t('price')}
              </label>
              <input
                name="price"
            ...
            <div className="dress-input">
              <label className="label font-semibold block mb-2.5" htmlFor="discount">
                {t('discount')}
              </label>
              <input
                name="discount"
            ...
            <div className="dress-input">
              ...
              <FormControl fullWidth>
                <Select labelId="multi-select-label" id="multi-select" value={data.sellerId} name="sellerId" onChange={handleInput}>
            ...
            <div className="dress-input">
              <label className="label font-semibold block mb-2.5" htmlFor="category">
                {t('category')}
              </label>
              <FormControl fullWidth>
                <Select labelId="multi-select-label" id="multi-select" value={data.categoryId} name="categoryId" onChange={handleInput}>
            ...
            <div className="dress-input sizes">
              <div className="label font-semibold block mb-2.5" htmlFor="category">
                {t('province')}
              </div>
              <div className="size flex flex-wrap items-center">
                <FormControl fullWidth>
                  <Select labelId="multi-select-label" id="multi-select" onChange={handleVelayat} value={data.welayat}>
            ...
            <div className="dress-input">
              <div className="label font-semibold block mb-2.5" htmlFor="name-tm">
                {t('color')}
              </div>
                ...
                {dataColor?.length > 0 &&
                  dataColor?.map((color, index) => (
                    <button
                      ...
                      key={index}
                      className={
                        'rounded-full mr-3 border-blue-600 ' + (colorIndex === index || color.id === data.colorId ? 'border-2 p-0.5' : '')
                      }
                    >
            ...
            <div className="dress-input sizes col-span-2">
              ...
              <div className="size flex flex-wrap items-center">
                <FormControl fullWidth>
                  <Select labelId="multi-select-label" id="multi-select" value={selectedSize} name="Size" onChange={handleSize}>
                    {dataSize.map((option) => (
              ...
              sizes.map((size, index) => (
                <div key={index} className="col-span-2">
                  <div className="dress-input sizes flex justify-between items-center">
                    <div className="dress-input">
                      <label className="label font-semibold block mb-2.5" htmlFor="name-tm">
                        {size.name} {t('quantity')}
                      </label>
                      <input
                        name="stock"
                        id={index}
                        value={size.stock}
                        onChange={handleSizeSub}
                        type="number"
                        className="w-full text-lybas-gray bg-gray-100 rounded-lg outline-none px-5 py-2.5"
                        placeholder={t('quantity')}
                      />
                    </div>
                    <button className="bg-red-400 rounded text-white py-1 h-10 px-10 mt-5" onClick={() => sizeDelete(index)}>
                      {t('delete')}
                    </button>
                  </div>
                </div>
            ...
            <div className="dress-input sizes col-span-2">
              <label className="label font-semibold block mb-2.5" htmlFor="body-tm">
                {t('writeContentTm')}
              </label>
              <textarea
                name="body_tm"
                value={data.body_tm}
                onChange={handleInput}
                className="w-full text-lybas-gray bg-gray-100 rounded-lg outline-none px-5 py-2.5 resize-none"
                placeholder={t('writeContentTm')}
                id="body-tm"
                cols="30"
                rows="5"
              ></textarea>
            ...
            <div className="dress-input sizes col-span-2">
              <label className="label font-semibold block mb-2.5" htmlFor="body-en">
                {t('writeContentEn')}
              </label>
              <textarea
                name="body_en"
            ...
            <div className="dress-input sizes col-span-2">
              <label className="label font-semibold block mb-2.5" htmlFor="body-ru">
                {t('writeContentRu')}
              </label>
              <textarea
                name="body_ru"
        ...
        <div className="right-container w-2/5 h-[70vh]">
          ...
          <div className="actions flex mt-10">
            <button onClick={() => navigate('/super/dresses')} className="bg-white border mr-5 w-full py-2 rounded hover:bg-gray-100">
              {t('cancel')}
            </button>
            <button
              disabled={loading}
              onClick={sendData}
              className={
                'text-white border flex items-center justify-center w-full py-2 rounded ' +
                (loading ? 'bg-gray-500 opacity-60' : 'bg-lybas-blue hover:bg-blue-800')
              }
            >
