...
function Filter({ children, open, setOpen }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <div
        className={
          'absolute z-10 top-12 right-0 bg-white rounded-lg shadow-lybas-1 transition-all origin-top ' + (open ? 'scale-y-1' : 'scale-y-0')
        }
      >
        {children}
      </div>
