...
export default function ForgotUserVerificationPopup({ open, setOpen, data, setOpenChangePassword }) {
                  ...
                  <div className="">
                    <div className="mt-3 text-center">
                      ...
                      <div className="inputs py-3">
                        <span className="text-left text-lybas-gray block w-full mb-3">
                          {t('verificationHelpWord') + ' ' + (data?.user_phone ? data?.user_phone : '')}
                        </span>
                        <input
                          type="text"
