...
const resources = {
  en: {
    translation: {
      ...
      deliveryAbroadDefinition:
        'Please enter the URL link of the product you want to be shipped abroad and leave your contact details. We will get in touch with you regarding your inquiry.',
      URLlink: 'URL link',
  ...
  ru: {
    translation: {
      ...
      recommendedDress: 'Рекомендуемые',
      ...
      deliveryAbroadDefinition:
        'Пожалуйста, введите URL-ссылку на товар, который вы хотите отправить за границу, и оставьте свои контактные данные. Мы свяжемся с вами по поводу',
      URLlink: 'URL-ссылка',
      doYouWantToDelete: 'Do you really want to delete?', //
      favorites: 'Favorites', //
      login: 'Войти',
  ...
  tm: {
    translation: {
      ...
      deliveryAbroadDefinition:
        'Daşary ýurda ibermek isleýän harydyňyzyň URL ssylkasyny giriziň we aragatnaşyk maglumatlaryňyzy ýazyň. Siz bilen habarlaşarys.',
      URLlink: 'URL ssylka',
